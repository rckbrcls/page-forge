...
const XML_DECLARATION_DOCTYPE = /<!\s*DOCTYPE\b/i;
...
function assertNoDtd(text: string): void {
  if (XML_DECLARATION_DOCTYPE.test(text)) {
    throw new SafeXmlError("doctype_forbidden", "DOCTYPE declarations are not supported.");
  }
}
