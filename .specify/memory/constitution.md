...
- Bump rationale: the public distribution contract now permits an ad-hoc,
  non-notarized Sparkle channel with embedded update services and repository
  release scripts.
- Modified principles:
  - Lightweight Native macOS Application
  - Simple, Reviewable Distribution
- Added obligations:
  - Sparkle update archives use EdDSA signatures and HTTPS feeds.
  - App Sandbox grants only the updater communication exception required by
    Sparkle.
  - Documentation discloses ad-hoc signing and missing notarization.
...
- Follow-up TODOs: clean-account installation and the first N-to-N+1 update
  remain separate runtime validation gates.
-->
...
ad-hoc code signing, Sparkle EdDSA archive signatures, an HTTPS appcast, GitHub
Pages publication, and a reviewable installer. Developer ID and notarization are
not release requirements for this channel. Documentation MUST disclose that
Gatekeeper does not trust the app as notarized Apple software.
...
**Version**: 6.0.0 | **Ratified**: 2026-07-17 | **Last Amended**: 2026-07-29
